...
export function AdminDashboard() {
  ...
  if (clientsLoading || paymentsLoading || ordersLoading) {
    return (
                ...
                {payments.map(payment => {
                  ...
                  return (
                    <div key={payment.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                      ...
                      <div className="flex gap-2">
                        {payment.status !== 'paid' && (
                          <Button size="sm" variant="outline" className="bg-green-400 hover:bg-green-300">
                            Mark Paid
                          </Button>
                        )}
                        <Button size="sm" variant="outline" className="bg-orange-400 hover:bg-orange-300">
                          Remind
                        </Button>
                      </div>
                    </div>
